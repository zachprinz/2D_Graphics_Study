...
{
public:
	Attack(std::string name,float damageMod,std::vector<sf::Vector2i> offsets,float cooldown, int animationY, int frames, bool isRanged,std::string anim, int trigger);
	Attack();
	bool hasTrigger;
	int triggerFrame;
